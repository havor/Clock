...
#include "cmath"
#include "ctime"
#include "LambdaSupport.h"

ClockDrawArea::ClockDrawArea()
:m_LineWidth{0.01},
 m_Radius{0.5}
{
	// TODO Auto-generated constructor stub
	//Use a timer with 1000 ms time out to refresh the clock
	Glib::signal_timeout().connect([this]()->bool{return on_time_out();}, 1000);
